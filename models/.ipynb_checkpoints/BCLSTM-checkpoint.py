...
#         self.n_classes = opt.output_dim
        ...
        self.smax_fc_act    = nn.Linear(self.dialogue_fc_dim, self.n_classes_act)
        
        self.smax_fc_emo    = nn.Linear(self.dialogue_fc_dim, self.n_classes_emo)
    ...
    def forward(self, in_modalities):
        ...
        log_prob_emo = F.log_softmax(output_emo, 2) # batch, seq_len,  n_classes
        
        
        log_prob_act = F.log_softmax(output_act, 2) # batch, seq_len,  n_classes
